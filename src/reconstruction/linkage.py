...
def _build_settings() -> SettingsCreator:
    ...
    return SettingsCreator(
        ...
        blocking_rules_to_generate_predictions=[
            ...
            # Fallback 2: same forename AND same estimated birth year.
            # Catches pairs who moved across a townland boundary between census
            # years (breaking the place_id block) AND have a surname spelling
            # variant whose prefix differs (breaking the substr block).  At
            # Tullynaught scale the candidate pairs generated by this rule are
            # modest; the forename+birth_year combination is specific enough
            # that false-positive pair volume stays manageable.
            block_on("forename_norm", "birth_year_est"),
        ],
        comparisons=[
