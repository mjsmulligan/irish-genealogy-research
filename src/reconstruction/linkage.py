...
def _build_settings() -> SettingsCreator:
    ...
    return SettingsCreator(
        ...
        comparisons=[
            ...
            # High discriminating power — two Pat McCaddens are disambiguated
            # by whether their wives are Mary vs Anne.
            # NullLevel fires when either person has no concluded couple relationship.
            cl.CustomComparison(
                comparison_levels=[
            ...
            # Sibling name overlap: same pattern as child_names.
            # Lower weight than children — siblings are an inferred relationship
            # (one step removed from direct evidence) so carry more noise.
            cl.CustomComparison(
                comparison_levels=[
